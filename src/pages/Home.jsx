  ...
  return (
    <div className="w-full">
      ...
      <div className="container flex justify-start gap-12 ml-3">
        <button
          onClick={() => onClick("dog")}
          className="card w-[9rem] badge badge-outline badge-secondary h-[8rem] justify-center items-center"
        >
        ...
        <button
          onClick={() => onClick("cat")}
          className="card w-[9rem]  badge badge-outline badge-primary h-[8rem] justify-center items-center"
        >
